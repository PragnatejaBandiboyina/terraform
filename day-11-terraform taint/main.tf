...
resource "aws_instance" "server" {
  ami                         = "ami-0cae6d6fe6048ca2c" # ec2-user AMI
...
resource "null_resource" "run_script" {
  provisioner "remote-exec" {
    ...
    inline = [
      "echo 'hello from Pragnateja' > /home/ec2-user/file200"
    ]
  }
...
#instead of triggers we can use terraform taint after plan and apply terraform taint <resourcename>
# if we update any new content our resource will get destroyed and again creates with new updated content
